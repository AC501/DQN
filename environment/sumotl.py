                ...
                # if tlID == "2":# or tlID == "5" or tlID == "4" or tlID == "8":
                    ...
                    # if traci.trafficlight.getPhase(tlID) == 0 or traci.trafficlight.getPhase(tlID) == 3:
                        ...
                        if self.__trafficlights[tlID]["greenTime"] > (minGreenTime - 1) and (self.__trafficlights[tlID][
                            ...
                            # reward *= -1
                            # reward = currentQueue[int(tlID)] * -1
                            print(tick," ",tlID," ",reward," ",currentQueue[int(tlID)]," ",traci.trafficlight.getPhase(tlID))

                            # print(tick, currentQueue[0], " ",
                            #             currentQueue[1], " ",
                            #             currentQueue[2], " ",
                            #             currentQueue[3], " ",
                            #             currentQueue[4], " ",
