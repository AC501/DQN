...
class SUMOTrafficLights(Environment):
    ...
    * the transitions between states are deterministic
    ...
    def run_episode(self, max_steps=-1, filename="queue_file.txt", exp=None):
        queue_file = open(filename, 'w')  # para salvar saida em um arquivo
